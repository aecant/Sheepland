...
import it.polimi.deib.provaFinale.alessandro_cantini_alessandro_dignani.rete.ConnessioneDatiPartitaImpl;
...
public class Server {
	...
	public static void main(String[] args) {
		try {
			ConnessioneDatiPartita dati = new ConnessioneDatiPartitaImpl();
			ConnessioneDatiPartita stub = (ConnessioneDatiPartita) UnicastRemoteObject.exportObject(dati, 0);
