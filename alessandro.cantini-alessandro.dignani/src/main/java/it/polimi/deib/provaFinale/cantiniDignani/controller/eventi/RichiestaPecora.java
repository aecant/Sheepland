...
public abstract class RichiestaPecora extends Richiesta {
	...
	private int t1, t2;
	private ArrayList<TipoAnimale> oviniT1, oviniT2;

	public RichiestaPecora(int t1, Collection<TipoAnimale> oviniT1, int t2, Collection<TipoAnimale> oviniT2) {
		this.t1 = t1;
		this.t2 = t2;
		this.oviniT1 = (ArrayList<TipoAnimale>) oviniT1;
		this.oviniT2 = (ArrayList<TipoAnimale>) oviniT2;
	}
	...
	protected List<TipoAnimale> getOviniT1() {
		return oviniT1;
	}

	protected List<TipoAnimale> getOviniT2() {
		return oviniT2;
	}
